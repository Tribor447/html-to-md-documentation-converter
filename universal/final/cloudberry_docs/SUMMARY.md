...
- [Introduction](#index)
  ...
  - [Architecture](#introduction-cbdb-architecture)
  - [User Scenarios](#introduction-cbdb-scenarios)
  - [Comparison with Greenplum Features](#introduction-cbdb-vs-gp-features)
- [Build Apache Cloudberry](#build)
  - [Build from Source (Complete Guide)](#build)
    - [Quick Build](#build-quick-build)
    - [Create and configure the gpadmin User](#build-create-gpadmin-user)
    - [Configure System settings](#build-system-settings)
    - [Install required packages](#build-install-required-packages)
    - [Download Source Code](#build-download-source-code)
    - [Configure Apache Cloudberry Build](#build-configure)
    - [Build and Install Apache Cloudberry and contrib extensions](#build-build-and-install)
    - [Set up a Cloudberry demo cluster](#build-set-demo-cluster)
    - [Post installation](#build-post-installation)
  - [Build with Docker Dev Image](#build-build-based-on-docker)
  - [Get Started with Sandbox](#build-sandbox)
- [Deploy in Production](#deployment)
  - [Quick Deployment Guide](#deployment-quick-deploy)
  - [Platform Requirements](#deployment-platform-requirements)
  - [Estimating storage capacity](#deployment-capacity_planning)
  - [Configuring Your Systems](#deployment-prepare-to-deploy)
  - [Installing Using RPM/DEB Package](#deployment-install_cloudberry)
  - [Creating the Data Storage Areas](#deployment-create_data_dirs)
  - [Validating Hardware and Network](#deployment-validate)
  - [Initializing Apache Cloudberry](#deployment-init_cloudberry)
  - [Logging into Apache Cloudberry](#deployment-login_cloudberry)
  - [(Optional) Deploy with a Single Computing Node](#deployment-single-node)
  - [Example Ansible Playbook](#deployment-ansible-example)
- [Basic Database Operations](#database-basic-create-and-manage-database)
  - [Create and Manage Database](#database-basic-create-and-manage-database)
  - [Start and Stop Database](#database-basic-start-and-stop-cbdb-database)
  - [Connect to Database](#database-basic-connect-to-cbdb)
