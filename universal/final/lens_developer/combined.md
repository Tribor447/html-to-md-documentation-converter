...
<!-- source_url: https://lens.apache.org/developer/contribute.html -->

<!-- page_index: 1 -->

<a id="contribute--developer-documentation-:-how-to-contribute-to-apache-lens"></a>

## Developer Documentation : How to contribute to Apache Lens?

- [Developer Documentation : How to contribute to Apache Lens?](#contribute--developer_documentation_:_how_to_contribute_to_apache_lens)
  - [Contributions](#contribute--contributions)
  - [Development Environment Setup](#contribute--development_environment_setup)
    - [Source Repository](#contribute--source_repository)
    - [Build tools](#contribute--build_tools)
    - [Integrated Development Environment (IDE)](#contribute--integrated_development_environment_ide)
  - [Building from source](#contribute--building_from_source)
    - [Building Lens from Source](#contribute--building_lens_from_source)
    - [Building Hive from Source](#contribute--building_hive_from_source)
  - [Code Contributions](#contribute--code_contributions)
    - [Code compliance](#contribute--code_compliance)
    - [Naming convention for configuration properties](#contribute--naming_convention_for_configuration_properties)
  - [How do I suggest my code changes to the community?](#contribute--how_do_i_suggest_my_code_changes_to_the_community)
    - [Generate a patch](#contribute--generate_a_patch)
      - [Creating patch](#contribute--creating_patch)
      - [Naming your patch](#contribute--naming_your_patch)
      - [Testing your patch](#contribute--testing_your_patch)
      - [Applying a patch](#contribute--applying_a_patch)
    - [Review request](#contribute--review_request)
      - [Posting a review request](#contribute--posting_a_review_request)
      - [After the patch is merged](#contribute--after_the_patch_is_merged)
    - [Submit patch](#contribute--submit_patch)
    - [Unifying the above](#contribute--unifying_the_above)
  - [Quality improvements](#contribute--quality_improvements)
  - [Documentation](#contribute--documentation)
    - [Project documentation](#contribute--project_documentation)
      - [Lens Menu](#contribute--lens_menu)
      - [User Menu](#contribute--user_menu)
      - [Admin Menu](#contribute--admin_menu)
      - [Developer Menu](#contribute--developer_menu)
    - [Configuration documentation](#contribute--configuration_documentation)
    - [REST api documentation](#contribute--rest_api_documentation)
    - [Feature documentation](#contribute--feature_documentation)
    - [Confluence usage](#contribute--confluence_usage)
  - [Review](#contribute--review)
  - [Becoming a committer](#contribute--becoming_a_committer)
  - [Stay involved](#contribute--stay_involved)
  - [Developer FAQ](#contribute--developer_faq)
    - [How to update documentation?](#contribute--how_to_update_documentation)
    - [How to update the config docs?](#contribute--how_to_update_the_config_docs)
    - [How to update CLI doc?](#contribute--how_to_update_cli_doc)
    - [How to add license headers for newly added files?](#contribute--how_to_add_license_headers_for_newly_added_files)
    - [How to check all licenses are fine?](#contribute--how_to_check_all_licenses_are_fine)
    - [What is versioning strategy in Lens?](#contribute--what_is_versioning_strategy_in_lens)
    - [What is the branching strategy in Lens?](#contribute--what_is_the_branching_strategy_in_lens)
    - [How to add a new Driver in Lens? Please refer to this wiki article. For examples you can refer to the following review board requests 1. Druid driver in Lens 2. Elastic Search Driver](#contribute--how_to_add_a_new_driver_in_lens_please_refer_to__this_wiki_article._for_examples_you_can_refer_to_the_following_review_board_requests_1.__druid_driver_in_lens_2.__elastic_search_driver)
    - [How to add a new Error Code in Lens? Please refer to this wiki article](#contribute--how_to_add_a_new_error_code_in_lens_please_refer_to__this_wiki_article)
...
<a id="contribute--contributions"></a>
...
<a id="contribute--development-environment-setup"></a>

### Development Environment Setup

Below sections guide a developer on how to contribute code or doc changes to Lens.

<a id="contribute--source-repository"></a>

#### Source Repository

Lens uses  [git](http://git-scm.com/) for its code repository. The repository is available at <https://git-wip-us.apache.org/repos/asf/lens.git>.
...
<a id="contribute--integrated-development-environment-ide"></a>
...
<a id="contribute--building-from-source"></a>

### Building from source

<a id="contribute--building-lens-from-source"></a>

#### Building Lens from Source

Download Apache Lens source release from  [here](https://lens.apache.org/releases/download.html).
...
Apache Lens depends on Hive. Please  [build](#contribute--building_hive_from_source) Hive from Source or install it using the documentation  [here](https://lens.apache.org/lenshome/install-and-run.html#Installing_Hive). After installing Lens and Hive, refer  [here](https://lens.apache.org/lenshome/install-and-run.html#Running_Lens) for running lens client and lens server from installation directories.

<a id="contribute--building-hive-from-source"></a>
...
<a id="contribute--code-contributions"></a>
...
<a id="contribute--code-compliance"></a>
...
- Project documentation corresponding to the change should be updated along with the code change. See [Documentation](#contribute--documentation) section to know how Lens documentation is organized and how to update
...
<a id="contribute--naming-convention-for-configuration-properties"></a>
...
<a id="contribute--how-do-i-suggest-my-code-changes-to-the-community"></a>
...
- [Generate a patch](#contribute--generate_a_patch)
- [Create a review request](#contribute--review_request)
- [Submit the patch](#contribute--submit_patch)
- [Unified way of doing both of these in one step](#contribute--unifying_the_above)

<a id="contribute--generate-a-patch"></a>

#### Generate a patch

<a id="contribute--creating-patch"></a>
...
<a id="contribute--naming-your-patch"></a>
...
<a id="contribute--testing-your-patch"></a>
...
<a id="contribute--applying-a-patch"></a>
...
<a id="contribute--review-request"></a>
...
<a id="contribute--posting-a-review-request"></a>
...
<a id="contribute--after-the-patch-is-merged"></a>
...
<a id="contribute--submit-patch"></a>
...
<a id="contribute--unifying-the-above"></a>
...
<a id="contribute--quality-improvements"></a>
...
<a id="contribute--documentation"></a>
...
<a id="contribute--project-documentation"></a>
...
<a id="contribute--developer-menu"></a>
...
<a id="contribute--configuration-documentation"></a>

#### Configuration documentation

Configuration pages should be linked from user guide and admin guide with respect to the configuration exposed to them. See  [Developer FAQ](#contribute--developer_faq) on how to update config docs.

<a id="contribute--rest-api-documentation"></a>
...
<a id="contribute--feature-documentation"></a>
...
<a id="contribute--confluence-usage"></a>
...
- Code style as per [coding guidelines in contributer guide](#contribute--code_compliance)
...
<a id="contribute--becoming-a-committer"></a>
...
<a id="contribute--stay-involved"></a>

### Stay involved

Contributors should join the Lens [mailing lists](https://lens.apache.org/mail-lists.html). In particular, the commit list (to see changes as they are made), the dev list (to join discussions of changes) and the user list (to help others). Also refer to  [Apache contributors guide](http://www.apache.org/dev/contributors.html) and  [Apache voting process](http://www.apache.org/foundation/voting.html).

<a id="contribute--developer-faq"></a>

### Developer FAQ

<a id="contribute--how-to-update-documentation"></a>
...
<a id="contribute--how-to-update-the-config-docs"></a>
...
<a id="contribute--how-to-update-cli-doc"></a>
...
<a id="contribute--how-to-add-license-headers-for-newly-added-files"></a>
...
<a id="contribute--how-to-check-all-licenses-are-fine"></a>
...
<a id="contribute--what-is-versioning-strategy-in-lens"></a>
...
<a id="contribute--what-is-the-branching-strategy-in-lens"></a>
...
<a id="contribute--how-to-add-a-new-driver-in-lens-please-refer-to-this-wiki-article-.-for-examples-you-can-refer-to-the-following-review-board-requests-1.-druid-driver-in-lens-2.-elastic-search-driver"></a>

#### How to add a new Driver in Lens? Please refer to [this wiki article](https://cwiki.apache.org/confluence/display/LENS/Lens+Driver). For examples you can refer to the following review board requests 1. [Druid driver in Lens](https://reviews.apache.org/r/43649/) 2. [Elastic Search Driver]( https://reviews.apache.org/r/36434/)

<a id="contribute--how-to-add-a-new-error-code-in-lens-please-refer-to-this-wiki-article"></a>

#### How to add a new Error Code in Lens? Please refer to [this wiki article](https://cwiki.apache.org/confluence/display/LENS/How+to+add+new+Error+Code)
