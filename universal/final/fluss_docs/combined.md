...
- [Maintenance](#maintenance-configuration)
  ...
  - [File Systems](#maintenance-filesystems-overview)
    ...
    - [Google Cloud Storage](#maintenance-filesystems-gs)
...
![arch](assets/images/fluss-0ea44a46f3b73dd114964443d9cbec5f_81a9e29b38c2c3e0.png)
...
" \ 
    -p 9123:9123 \ 
    -d apache/fluss:0.9.1-incubating coordinatorServer 
```
...
remote.data.dir: /tmp/fluss/remote-data" \ 
    ...
    -d apache/fluss:0.9.1-incubating tabletServer 
```
...
> [!NOTE]
> : Make sure the [Fluss Flink connector jar](#engine-flink-getting-started--dependencies) has already been copied to the `lib` directory of your Flink home.
...
```sql
CREATE TABLE T (k  INT,v1 DOUBLE,v2 STRING,PRIMARY KEY (k) NOT ENFORCED );
-- Insert INSERT INTO T(k, v1, v2) VALUES (1, 1.0, 't1'); INSERT INTO T(k, v1, v2) VALUES (1, 1.0, 't2'); SELECT * FROM T WHERE k = 1; -- Output:+----+-----+----+ | k  | v1  | v2 | +----+-----+----+ | 1  | 1.0 | t2 | +----+-----+----+
-- Update INSERT INTO T(k, v1, v2) VALUES (2, 2.0, 't2'); -- Switch to batch mode to perform update operation for UPDATE statement is only supported for batch mode currently SET execution.runtime-mode = batch; UPDATE T SET v1 = 4.0 WHERE k = 2; SELECT * FROM T WHERE k = 2; -- Output:+----+-----+----+ | k  | v1  | v2 | +----+-----+----+ | 2  | 4.0 | t2 | +----+-----+----+
-- Partial Update INSERT INTO T(k, v1) VALUES (3, 3.0); -- set v1 to 3.0 SELECT * FROM T WHERE k = 3; -- Output:+----+-----+------+ | k  | v1  | v2   | +----+-----+------+ | 3  | 3.0 | null | +----+-----+------+ INSERT INTO T(k, v2) VALUES (3, 't3'); -- set v2 to 't3' SELECT * FROM T WHERE k = 3; -- Output:+----+-----+----+ | k  | v1  | v2 | +----+-----+----+ | 3  | 3.0 | t3 | +----+-----+----+
-- Delete DELETE FROM T WHERE k = 2; -- Switch to streaming mode SET execution.runtime-mode = streaming; SELECT * FROM T; -- Output:+----+-----+----+ | k  | v1  | v2 | +----+-----+----+ | 1  | 1.0 | t2 | +----+-----+----+ | 3  | 3.0 | t3 | +----+-----+----+
```
...
<div class="theme-tabs-container tabs-container tabList__CuJ"><ul><li>Flink 1.20</li><li>Flink 1.19</li><li>Flink 1.18</li></ul><div><div><div><div><pre><code><div><span>&lt;!-- https://mvnrepository.com/artifact/org.apache.fluss/fluss-flink-1.20 --&gt;</span><span></span> </div><div><span></span><span>&lt;</span><span>dependency</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>groupId</span><span>&gt;</span><span>org.apache.fluss</span><span>&lt;/</span><span>groupId</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>artifactId</span><span>&gt;</span><span>fluss-flink-1.20</span><span>&lt;/</span><span>artifactId</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>version</span><span>&gt;</span><span>0.9.1-incubating</span><span>&lt;/</span><span>version</span><span>&gt;</span><span></span> </div><div><span></span><span>&lt;/</span><span>dependency</span><span>&gt;</span> </div></code></pre></div></div></div><div><div><div><pre><code><div><span>&lt;!-- https://mvnrepository.com/artifact/org.apache.fluss/fluss-flink-1.19 --&gt;</span><span></span> </div><div><span></span><span>&lt;</span><span>dependency</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>groupId</span><span>&gt;</span><span>org.apache.fluss</span><span>&lt;/</span><span>groupId</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>artifactId</span><span>&gt;</span><span>fluss-flink-1.19</span><span>&lt;/</span><span>artifactId</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>version</span><span>&gt;</span><span>0.9.1-incubating</span><span>&lt;/</span><span>version</span><span>&gt;</span><span></span> </div><div><span></span><span>&lt;/</span><span>dependency</span><span>&gt;</span> </div></code></pre></div></div></div><div><div><div><pre><code><div><span>&lt;!-- https://mvnrepository.com/artifact/org.apache.fluss/fluss-flink-1.18 --&gt;</span><span></span> </div><div><span></span><span>&lt;</span><span>dependency</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>groupId</span><span>&gt;</span><span>org.apache.fluss</span><span>&lt;/</span><span>groupId</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>artifactId</span><span>&gt;</span><span>fluss-flink-1.18</span><span>&lt;/</span><span>artifactId</span><span>&gt;</span><span></span> </div><div><span>    </span><span>&lt;</span><span>version</span><span>&gt;</span><span>0.9.1-incubating</span><span>&lt;/</span><span>version</span><span>&gt;</span><span></span> </div><div><span></span><span>&lt;/</span><span>dependency</span><span>&gt;</span> </div></code></pre></div></div></div></div></div>
...
| Artifact | Jar |
| --- | --- |
| Fluss Paimon lake connector | [fluss-lake-paimon-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-lake-paimon/0.9.1-incubating/fluss-lake-paimon-0.9.1-incubating.jar) |
...
Verify downloaded JARs against the [KEYS file](https://downloads.apache.org/incubator/fluss/KEYS) using the [verification instructions](https://fluss.incubator.apache.org/downloads/#verifying-downloads).
...
Download the [fluss-lake-paimon-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-lake-paimon/0.9.1-incubating/fluss-lake-paimon-0.9.1-incubating.jar) and [paimon-bundle-1.3.1.jar](https://repo.maven.apache.org/maven2/org/apache/paimon/paimon-bundle/1.3.1/paimon-bundle-1.3.1.jar), and place it into `${FLINK_HOME}/lib`.
...
```json
[{"partition_name": "date=2025","partition_id": 0,"bucket": 0,"offset": 3 },{"partition_name": "date=2025","partition_id": 1,"bucket": 0,"offset": 3}]
```
...
| Artifact | Jar |
| --- | --- |
| Fluss Iceberg lake connector | [fluss-lake-iceberg-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-lake-iceberg/0.9.1-incubating/fluss-lake-iceberg-0.9.1-incubating.jar) |
...
- **Fluss Flink Connector**: Put the Fluss Flink connector JAR into `${FLINK_HOME}/lib` — see [Dependencies](#engine-flink-getting-started--dependencies) for all supported Flink versions.
  - For Flink 1.20: [fluss-flink-1.20-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-flink-1.20/0.9.1-incubating/fluss-flink-1.20-0.9.1-incubating.jar)

If you are using remote storage, download the corresponding Fluss filesystem JAR and place it into `${FLINK_HOME}/lib`:

- **Amazon S3**: see [S3 Dependencies](#maintenance-filesystems-s3--dependencies)
- **Aliyun OSS**: see [OSS Dependencies](#maintenance-filesystems-oss--dependencies)
- **HDFS**: see [HDFS Dependencies](#maintenance-filesystems-hdfs--dependencies)

- **Fluss Lake Iceberg**: Put [fluss-lake-iceberg-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-lake-iceberg/0.9.1-incubating/fluss-lake-iceberg-0.9.1-incubating.jar) into `${FLINK_HOME}/lib`
...
```bash
<FLINK_HOME>/bin/flink run /path/to/fluss-flink-tiering-0.9.1-incubating.jar \ 
...
| Artifact | Jar |
| --- | --- |
| Fluss Lance lake connector | [fluss-lake-lance-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-lake-lance/0.9.1-incubating/fluss-lake-lance-0.9.1-incubating.jar) |
...
- If you are using [Amazon S3](http://aws.amazon.com/s3/), [Aliyun OSS](https://www.aliyun.com/product/oss) or [HDFS(Hadoop Distributed File System)](https://hadoop.apache.org/docs/stable/) as Fluss's [remote storage](#maintenance-tiered-storage-remote-storage),
  you should download the corresponding Fluss filesystem JAR (see the [Filesystems](#maintenance-filesystems-overview) section) and also put it into `${FLINK_HOME}/lib`.
- Put [fluss-lake-lance-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-lake-lance/0.9.1-incubating/fluss-lake-lance-0.9.1-incubating.jar) into `${FLINK_HOME}/lib`.
...
| Artifact | Jar |
| --- | --- |
| Fluss HDFS filesystem plugin | [fluss-fs-hdfs-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-fs-hdfs/0.9.1-incubating/fluss-fs-hdfs-0.9.1-incubating.jar) |
...
| Artifact | Jar |
| --- | --- |
| Fluss OSS filesystem plugin | [fluss-fs-oss-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-fs-oss/0.9.1-incubating/fluss-fs-oss-0.9.1-incubating.jar) |
...
| Artifact | Jar |
| --- | --- |
| Fluss Azure filesystem plugin | [fluss-fs-azure-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-fs-azure/0.9.1-incubating/fluss-fs-azure-0.9.1-incubating.jar) |
...
1. **Prepare the plugin JAR**:
   ...
   - Download `fluss-fs-azure-0.9.1-incubating.jar` from the [Dependencies](#maintenance-filesystems-azure--dependencies) section above.
2. **Place the plugin**: Place the plugin JAR file in the `${FLUSS_HOME}/plugins/azure/` directory:


```bash
mkdir -p ${FLUSS_HOME}/plugins/azure/ 
cp fluss-fs-azure-0.9.1-incubating.jar ${FLUSS_HOME}/plugins/azure/ 
```
...
| Artifact | Jar |
| --- | --- |
| Fluss OBS filesystem plugin | [fluss-fs-obs-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-fs-obs/0.9.1-incubating/fluss-fs-obs-0.9.1-incubating.jar) |
...
1. **Prepare the plugin JAR**:
   ...
   - Download `fluss-fs-obs-0.9.1-incubating.jar` from the [Dependencies](#maintenance-filesystems-obs--dependencies) section above.
2. **Place the plugin**: Place the plugin JAR file in the `${FLUSS_HOME}/plugins/obs/` directory:


```bash
mkdir -p ${FLUSS_HOME}/plugins/obs/ 
cp fluss-fs-obs-0.9.1-incubating.jar ${FLUSS_HOME}/plugins/obs/ 
```
...
<a id="maintenance-filesystems-gs"></a>

<!-- source_url: https://fluss.incubator.apache.org/docs/maintenance/filesystems/gs/ -->
...
| Artifact | Jar |
| --- | --- |
| Fluss Google Cloud Storage filesystem plugin | [fluss-fs-gs-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-fs-gs/0.9.1-incubating/fluss-fs-gs-0.9.1-incubating.jar) |
...
1. **Prepare the plugin JAR**:
   ...
   - Download `fluss-fs-gs-0.9.1-incubating.jar` from the [Dependencies](#maintenance-filesystems-gs--dependencies) section above.
2. **Place the plugin**: Place the plugin JAR file in the `${FLUSS_HOME}/plugins/gs/` directory:


```bash
mkdir -p ${FLUSS_HOME}/plugins/gs/ 
cp fluss-fs-gs-0.9.1-incubating.jar ${FLUSS_HOME}/plugins/gs/ 
```
...
| Artifact | Jar |
| --- | --- |
| Fluss Flink tiering service | [fluss-flink-tiering-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-flink-tiering/0.9.1-incubating/fluss-flink-tiering-0.9.1-incubating.jar) |
...
Verify downloaded JARs against the [KEYS file](https://downloads.apache.org/incubator/fluss/KEYS) using the [verification instructions](https://fluss.incubator.apache.org/downloads/).
...
- Download [fluss-flink-tiering-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-flink-tiering/0.9.1-incubating/fluss-flink-tiering-0.9.1-incubating.jar) (see [Dependencies](#maintenance-tiered-storage-lakehouse-storage--dependencies))
...
- If you are using [Amazon S3](http://aws.amazon.com/s3/), [Aliyun OSS](https://www.aliyun.com/product/oss) or [HDFS(Hadoop Distributed File System)](https://hadoop.apache.org/docs/stable/) as Fluss's [remote storage](#maintenance-tiered-storage-remote-storage),
  you should download the corresponding Fluss filesystem JAR (see [Filesystems](#maintenance-filesystems-overview)) and also put it into `${FLINK_HOME}/lib`
- Put [fluss-lake-paimon-0.9.1-incubating.jar](https://repo1.maven.org/maven2/org/apache/fluss/fluss-lake-paimon/0.9.1-incubating/fluss-lake-paimon-0.9.1-incubating.jar) into `${FLINK_HOME}/lib`
...
After the Flink Cluster has been started, you can execute the `fluss-flink-tiering-0.9.1-incubating.jar` by using the following command to start datalake tiering service:
...
<FLINK_HOME>/bin/flink run \ 
    ...
    /path/to/fluss-flink-tiering-0.9.1-incubating.jar \ 
    --fluss.bootstrap.servers localhost:9123 \ 
    --datalake.format paimon \ 
    --datalake.paimon.metastore filesystem \ 
    --datalake.paimon.warehouse /tmp/paimon 
...
<Collector/all>\_count

The total number of collections that have occurred for the given (or all) collector.

Gauge

<Collector/all>\_time

The total time spent performing garbage collection for the given (or all) collector.

Gauge

<Collector/all>\_timeMsPerSecond

The time (in milliseconds) spent garbage collecting per second for the given (or all) collector.
