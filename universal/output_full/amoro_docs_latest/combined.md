...
See: [Optimizer Group Configuration](https://amoro.apache.org/docs/latest/managing-optimizers#optimizer-group)。
...
- [Self-optimizing scheduling policy](#self-optimizing--self-optimizing-scheduling-policy)
  - [Quota](#self-optimizing--quota)
  - [Balanced](#self-optimizing--balanced)
...
[Iceberg](#iceberg-format) 、[Paimon](https://amoro.apache.org/docs/latest/paimon-format)、[Mixed-Hive](#mixed-hive-format)、[Mixed-Iceberg](#mixed-iceberg-format).
...
- [REST Catalog](#managing-catalogs--rest-catalog)
  - [Nessie’s REST Catalog](#managing-catalogs--nessies-rest-catalog)
...
more information on modifying tables, please refer to the syntax guide [Spark DDL](https://amoro.apache.org/docs/latest/spark-ddl#alter-statement).
...
- [Create table](#using-tables--create-table)
  - [Configure LogStore](#using-tables--configure-logstore)
  - [Configure watermark](#using-tables--configure-watermark)
...
[**flink-cdc-ingestion**](https://amoro.apache.org/docs/latest/flink-cdc-ingestion) doc

At the same time, we provide [**Mixed-Iceberg**](https://amoro.apache.org/docs/latest/iceberg-format) format, which you can understand as
...
- [Environment preparation](#flink-getting-started--environment-preparation)
  - [Mixed-Hive format](#flink-getting-started--mixed-hive-format)
...
- [DROP statement](#flink-ddl--drop-statement)
  - [DROP DATABASE](#flink-ddl--drop-database)
  - [DROP TABLE](#flink-ddl--drop-table)
...
- [Writing With SQL](#flink-dml--writing-with-sql)
  - [INSERT OVERWRITE](#flink-dml--insert-overwrite)
  - [INSERT INTO](#flink-dml--insert-into)
...
- [Ingest into one table](#flink-cdc-ingestion--ingest-into-one-table)
  - [Iceberg format](#flink-cdc-ingestion--iceberg-format)
  - [Mixed-Iceberg format](#flink-cdc-ingestion--mixed-iceberg-format)
...
- [Writing with DataStream](#flink-datastream--writing-with-datastream)
  - [Overwrite data](#flink-datastream--overwrite-data)
  - [Appending data](#flink-datastream--appending-data)
...
- [Overview](#flink-using-logstore--overview)
  - [Prerequisites for using LogStore](#flink-using-logstore--prerequisites-for-using-logstore)
  - [Double write LogStore and FileStore](#flink-using-logstore--double-write-logstore-and-filestore)
...
- [Catalogs configuration](#spark-configuration--catalogs-configuration)
  - [Using Mixed-Format in a standalone catalog](#spark-configuration--using-mixed-format-in-a-standalone-catalog)
  - [Using Mixed-Format in session catalog](#spark-configuration--using-mixed-format-in-session-catalog)
...
- [CREATE TABLE](#spark-ddl--create-table)
  - [PRIMARY KEY](#spark-ddl--primary-key)
  - [PARTITIONED BY](#spark-ddl--partitioned-by)
...
- [Querying with SQL](#spark-queries--querying-with-sql)
  - [Querying Mixed-Format table by merge on read](#spark-queries--querying-mixed-format-table-by-merge-on-read)
  - [Query on change store](#spark-queries--query-on-change-store)
